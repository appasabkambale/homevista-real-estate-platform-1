...
import { X, Building2, Plus, Edit3, Trash2, MapPin, DollarSign, Eye, ExternalLink, BarChart3 } from 'lucide-react';
        ...
        <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Manage, update, and track performance of your active listings</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer border border-indigo-200"
            >
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0 border-t sm:border-t-0 pt-2 sm:pt-0">
                    <button
                      onClick={() => {
                        setIsMyPropertiesModalOpen(false);
                        openAnalyticsModal(prop.id);
                      }}
                      className="px-2.5 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl text-xs font-bold flex items-center gap-1 transition-colors cursor-pointer border border-indigo-100"
                      title="View Analytics & Conversion"
                    >
                      <BarChart3 className="w-3.5 h-3.5 text-indigo-600" />
                      <span>Stats</span>
                    </button>
